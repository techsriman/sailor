...
ADD https://download.java.net/java/GA/jdk11/9/GPL/openjdk-11.0.2_osx-x64_bin.tar.gz .
RUN tar -xvzf openjdk-11.0.2_osx-x64_bin.tar.gz 
RUN rm openjdk-11.0.2_osx-x64_bin.tar.gz
